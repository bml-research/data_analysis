...
Use the code block below to read the content of the files in the `files` directory in a dataframe object and assign it to the variable name `data`. There are 25 different files to practice your file loading skills.
