...
>They call the same function. ummarise() and summarize() are synonyms for UK and USA spelling.
...
The summarise_each() function is deprecated in favour of the new across() function that works within summarise() and mutate().
